...
Use the keybindings or P4 menu entries:
...
#+begin_example
 ...
 Workspace
   ...
   C-c p @   p4 sync      Synchronize the client with its view of the depot (p4 sync)
   C-c p C-@ p4 sync @=CN Sync ONLY the contents of a changelist number
